...
st.title("🌐 AI 글로벌 스펙 검토 및 다국어 지원 앱 (안정화 버전)")
...
# --- 2. [핵심] 작동하는 모델 자동 탐색 (1.5 Flash 최우선 적용) ---
def get_working_model():
    ...
    # 이미지 및 복잡한 언어 처리를 위한 모델 후보 목록 (1.5 Flash 최우선)
    # 기존: ['gemini-2.5-flash-preview', 'gemini-1.5-pro-001', 'gemini-pro']
    # 변경: 안정성이 높은 1.5-flash를 최우선으로 설정
    candidates = ['gemini-1.5-flash-001', 'gemini-1.5-pro-001', 'gemini-2.5-flash-preview']
