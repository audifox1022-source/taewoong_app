...
st.title("🌐 AI 글로벌 스펙 검토 및 다국어 지원 앱 (최소 안정화 버전)")
...
# --- 2. [핵심] 작동하는 모델 자동 탐색 (1.5 Flash 단일 및 Time-out 20초) ---
def get_working_model():
    ...
    # 이미지 및 복잡한 언어 처리를 위한 모델 후보 목록 (가장 안정적인 모델 하나로 단일화)
    candidates = ['gemini-1.5-flash-001']
